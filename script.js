...
const CATEGORY_3D_MODELS = {
    bone: {
        uid: '293f5f57f8ba47dbbbefa10df08eb2d4',
        title: 'Osteology',
        author: 'Z-Anatomy',
        url: 'https://sketchfab.com/3d-models/osteologie-293f5f57f8ba47dbbbefa10df08eb2d4'
    },
    muscle: {
...
function createResultCard(item) {
    ...
    if (model3D) {
        ...
        toggle3DBtn.addEventListener('click', () => {
            ...
            captionEl.innerHTML = `Showing the full ${model3D.title.toLowerCase()} system — rotate/zoom to find "${item.name}". Model: <a href="${model3D.url}" target="_blank" rel="noopener noreferrer">${model3D.title}</a> by ${model3D.author} (Sketchfab, CC BY-SA)`;
